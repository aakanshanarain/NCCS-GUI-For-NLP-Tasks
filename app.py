...
def cancerprediction():
    ...
    return render_template("model1.html", data=data, list=list, len=len, str=str, row_number=row_number,
...
def rulebasedmodelwebpage():
    ...
    # render HTML page dynamically
    return render_template("model2.html", data=data, list=list, len=len, str=str, row_number=row_number,
                           number_of_reports=number_of_reports)
